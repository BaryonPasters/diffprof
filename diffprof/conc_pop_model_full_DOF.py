...
def get_means_and_covs(p50_arr, conc_k, params_p50):
    ...
    be_params, mean_lgtc_params, mean_bl_params, cov_lgtc_bl_params, prev_fixed_params = _res
    mean_u_be, std_u_be = mean_and_cov_u_be(p50_arr, *be_params)
    _res = mean_and_cov_u_lgtc_bl(
        p50_arr, *mean_lgtc_params, *mean_bl_params, *cov_lgtc_bl_params, *prev_fixed_params
    )
...
def parse_all_params(params_p50):
    ...
    return be_params, mean_lgtc_params, mean_bl_params, cov_lgtc_bl_params, prev_fixed_params
